        ...
        try {
          ...
          set({
            ...
            songSuggestion: data.songRecommendation
              ? {
                  title: data.songRecommendation.title || "Unknown Title",
                  artist: data.songRecommendation.artist || "Unknown Artist",
                  genre: data.songRecommendation.genre || "Unknown Genre",
                  spotifyUrl: data.songRecommendation.spotifyUrl || "#",
                  previewUrl: data.songRecommendation.previewUrl || undefined,
                }
              : null,
          });
        } catch (error) {
