...
export const Navbar: React.FC = () => {
  const { isAuthenticated, logout } = userAuthStore();
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
            ...
            {isAuthenticated ? (
              <>
                ...
                <div className="relative">
                  ...
                  {isProfileMenuOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-xl shadow-lg py-1 border border-gray-100 dark:border-gray-700">
                      <Link
                        to="/profile"
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 shadow-lg">
